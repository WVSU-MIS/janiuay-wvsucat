...
def app():
    ...
    st.image(img)
    st.title("WVSU Janiuay Campus WVSUCAT Dashboard")      
    st.subheader("(c) 2023 WVSU Management Information System Office")
                 
    st.write("This dashboard is managed by: Dr. Guiller P. Pendon, Campus Administrator\njaniuay@wvsu.edu.ph")
    ...
    df_colleges = pd.read_csv('janiuay-courses.csv', header=0, sep = ",", encoding='latin')
